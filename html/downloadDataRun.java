...
public class downloadDataRun {
    ...
    static int orderByOrfNumber                               = 0x00002;
    ...
    static int includeTapTaggedInOutFile                      = 0x00100;
    static int includeAbundanceInOutFile                      = 0x00200;
    static int includeErrorInOutFile                          = 0x00400;
    static int orderByOrfName                                 = 0x00800;
    static int includeOligoSeq                                = 0x01000;
    static int includeCheckOligoSeq                           = 0x02000;
	...
	*/
	...
	if(gf(orderByOrfNumber)) {
	    OrfInfo.sortByOrfnumber = true;
	}
	...
	if(gf(includeTapTaggedInOutFile)) {
	    OrfInfo.printTapTagged = true;
	}
	if(gf(includeAbundanceInOutFile)) {
	    OrfInfo.printAbundance = true;
	}
	if(gf(includeErrorInOutFile)) {
	    OrfInfo.printError = true;
	}
	if(gf(includeOligoSeq)) {
	    OrfInfo.printOligoSeq = true;
	}
	if(gf(includeCheckOligoSeq)) {
	    OrfInfo.printCheckOligoSeq = true;
	}
