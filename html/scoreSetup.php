...
while($plateInfo = mysql_fetch_assoc($qryGetPlateInfo)) {
...
<input type="submit" name="buttonSpecificPlateSubmit" value="Score This Plate!!!">
</select>
</form>
-->
<form name="pruneSkippedOrfs" method="post" action="pruneLibraries.php">
<input type="submit" name="buttonSkippedSetSubmit" value="Score Skipped Orfs!!!">
</form>

<form name="scoreUnscoredOrfs" method="post" action="scoring_images.php">
<input type="submit" name="buttonUnscoredSubmit" value="Score Next Available Orf!!!">
</form>
